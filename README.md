...
4. **Testes** — verificação de desempenho, estabilidade e funcionalidade
5. **Documentação** — registro com fotos, relatos e resultados
6. **Doação** — entrega do equipamento a uma instituição de caridade
...
| Armazenamento | HD 512 GB SATA |
| Gabinete | Reutilizado |
| Fonte ATX | Nova (substituição do componente defeituoso) |
...
| Kaio Nunes | Manutenção, busca de peças e documentação |
| Diogo Durães | Manutenção, instalação de SO, busca de peças e documentação |
| Gabriel Gama | Manutenção, busca de peças e documentação |
...
© 2025 · Curso Técnico em Informática — Estácio de Sá
